...
DEFAULT_COMPONENT_TIME_SECONDS = 400
MAX_LESSON_NUMBER = 6
...
PLACEMENT_STAGE_TIME_RATIO = 0.35
PLACEMENT_STAGE_MIN_SECONDS = 15
WINDOW_STAGE_TIME_RATIO = 0.35
WINDOW_STAGE_MIN_SECONDS = 15
QUALITY_STAGE_MIN_SECONDS = 0.25
