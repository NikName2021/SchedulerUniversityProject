    ...
    <div className="min-h-screen">
      ...
      <header style={{
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 style={{ fontSize: '1.125rem', fontWeight: 800, color: 'var(--text-primary)' }}>Scheduler</h1>
            <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', fontWeight: 600 }}>University MVP</p>
          </div>
        </div>
